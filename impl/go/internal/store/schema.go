...
// schemaSQL is the embedded copy of shared/schema/0001_init.sql.
// Go's go:embed cannot reach outside the module so this string MUST
// stay byte-identical to that file. When you change one, change both
// in the same commit.
const schemaSQL = `
